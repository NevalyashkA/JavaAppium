...
public class MainPageObject {
    ...
    public void assertElementHasText(String locator, String text, String error_message, long timeoutInSeconds){
        WebElement element = waitForElementPresent(locator,error_message,timeoutInSeconds);
    ...
    public boolean waitForListElement(String by_parent, String locator, String error_message, long timeoutInSeconds){
        By by = this.getLocatorByString(locator);
...
//        WebElement element = this.waitForElementAndClick(locator, error_message, timeoutInSeconds);
//
//    }
    ...
    public void tryClickElementWithFewAttempts(String locator, String error_message, int amount_of_attempt){
        ...
        while (need_more_attempts){
            try {
                ...
                if(current_attempt > amount_of_attempt){
                    this.waitForElementAndClick(locator,error_message,1);
                }
            }
            ++ current_attempt;
